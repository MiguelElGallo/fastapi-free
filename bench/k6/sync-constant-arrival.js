...
const RATE = Number(__ENV.RATE || __ENV.TARGET_RPS || '50');
const DURATION = __ENV.DURATION || '5m';
const PRE_ALLOCATED_VUS = Number(__ENV.PRE_ALLOCATED_VUS || __ENV.PREALLOCATED_VUS || '50');
const MAX_VUS = Number(__ENV.MAX_VUS || '200');
const FAILED_RATE_THRESHOLD = __ENV.FAILED_RATE_THRESHOLD || 'rate<=0.001';
const P99_THRESHOLD = __ENV.P99_THRESHOLD || 'p(99)<1000';
const CHECKS_THRESHOLD = __ENV.CHECKS_THRESHOLD || 'rate==1.0';

export const options = {
  scenarios: {
    sync_constant_arrival: {
      ...
      maxVUs: MAX_VUS,
      tags: {
        suite: 'sync-constant-arrival',
      },
    },
  },
  thresholds: {
    http_req_failed: [FAILED_RATE_THRESHOLD],
    http_req_duration: [P99_THRESHOLD],
    checks: [CHECKS_THRESHOLD],
  },
};
